...
window.onload = function() {
    function clock() {
        ...
        if (hours > 17) {
            moonAnimation();
            TweenMax.to(".background", 15, {
                backgroundImage: "radial-gradient(circle at 250px 250px, #805370, #674E75, #3B4372, #2C2F5A, black)",
                repeat: -1,
                yoyo: true
            });
            //SHADOW
            TweenMax.to(".time, .clock", 15, {
                textShadow: "0 0 10px rgba(10, 175, 230, 1), 0 0 4px rgba(10, 175, 230, 0)",
                repeat: -1,
                yoyo: true
            });
            //STAR ANIMATION
            TweenMax.staggerFrom("div.stars p", 1, {
                opacity: 1,
                repeat: -1,
                yoyo: true
            });
